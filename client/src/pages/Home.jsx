...
import { QUERY_SAVEDATA, QUERY_WORLD, QUERY_ENVIRONMENT, QUERY_HEROES } from '../utils/queries';

const Home = () => {
  const { loading, data } = useQuery(QUERY_SAVEDATA, QUERY_WORLD, QUERY_ENVIRONMENT, QUERY_HEROES);
